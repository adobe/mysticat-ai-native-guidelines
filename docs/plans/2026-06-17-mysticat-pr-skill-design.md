...
| 2026-06-17 | Rainer Friederich | Review (MysticatBot nits): gloss `upstream_docs_paths` at first use in §E; de-jargon template §4 comment ("most specs live" instead of the DOCUMENTATION-GUIDE 70% rule) |
